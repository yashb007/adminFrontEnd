...
class ProductGallaryView extends React.Component {
  state = {
    language_id: '1',
    language_data: [
      {
  ...
  componentDidMount() {
    if (this.props.match.params.post_id !== undefined &&
      ...
      var decode_id2 = hashids.decode(this.props.match.params.post_id)
      this.setState({ post_id: decode_id[0], post_id: decode_id2[0] })
      console.log(decode_id2)
    }
    if (this.props.match.params.post_id !== undefined &&
      this.props.match.params.post_id !== null &&
      this.props.match.params.post_id !== 0 &&
      this.props.match.params.post_id !== '') {
      var decode_id2 = hashids.decode(this.props.match.params.post_id)
      this.setState({ post_id: decode_id2[0] })
      console.log(decode_id2)
    }
  }
  componentWillMount() {
    this.loadScript(process.env.PUBLIC_URL + "/files/assets/pages/filer/jquery.fileuploads.init.js");
  }
  loadScript(src) {
...
export default ProductGallaryView;
