...
import Addbanner from "./BannerAdd";
...
class BannerAddTab extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.banner_id !== undefined &&
      this.props.match.params.banner_id !== null &&
      this.props.match.params.banner_id !== 0 &&
      this.props.match.params.banner_id !== '') {
      var decode_id = hashids.decode(this.props.match.params.banner_id)
      this.setState({ banner_id: decode_id[0] })
