...
class BrandAddTab extends React.Component {
    state = {
        language_id: '1',
        language_data: [
            {
    ...
    componentDidMount() {
        if (this.props.match.params.brand_id !== undefined &&
            this.props.match.params.brand_id !== null &&
            this.props.match.params.brand_id !== 0 &&
            this.props.match.params.brand_id !== '') {
            var decode_id = hashids.decode(this.props.match.params.brand_id)
            this.setState({ brand_id: decode_id[0] })
                                    ...
                                    <div className="col-lg-8">
                                        <div className="page-header-title">
                                            <div className="d-inline">
                                                <h4>{this.props.match.params.brand_id ? "Edit" : "Add"}{" "} brand</h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="page-header-breadcrumb">
                                            <ul className="breadcrumb-title">
                                                ...
                                                <li className="breadcrumb-item active">
                                                    {this.props.match.params.brand_id ? "Edit" : "Add"}{" "} brand
                                                    </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="tab-pane  active"
                                                        id={"about_" + this.state.language_id} role="tabpanel" aria-labelledby="">
                                                        {
                                                            this.state.brand_id !== undefined &&
                                                                ...
                                                                this.state.brand_id !== ''
                                                                ?
                                                                <BrandAdd language_id={this.state.language_id}
