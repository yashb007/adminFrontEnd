  ...
  render() {
    ...
    const options = {
      ...
      renderExpandableRow: (rowData, rowMeta) => {
        var category_id = rowData[0];
        const colSpan = rowData.length + 1;
        for (var i = 0; i < this.state.category_list.length; i++) {
          if (i === rowMeta.dataIndex &&
            this.state.category_list[i].category_id === category_id) {
            console.log(this.state.category_list[i])
          }
        }
        return (
          < SubCategoryList colSpan={colSpan} />
        );
      },
                          ...
                          <MUIDataTable
                            title={
                              <div className="card-header">
                                ...
                                <Link
                                  to="/category/add"
                                  className="btn btn-sm btn-primary waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13">
