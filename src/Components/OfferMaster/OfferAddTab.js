...
class OfferAddTab extends React.Component {
    state = {
        language_id: '1',
        language_data: [
            {
    ...
    componentDidMount() {
        if (this.props.match.params.offer_id !== undefined &&
            this.props.match.params.offer_id !== null &&
            this.props.match.params.offer_id !== 0 &&
            this.props.match.params.offer_id !== '') {
            var decode_id = hashids.decode(this.props.match.params.offer_id)
            this.setState({ offer_id: decode_id[0] })
            console.log(this.props.match.params.offer_id)
        }
    }
                                    ...
                                    <div className="col-lg-8">
                                        <div className="page-header-title">
                                            <div className="d-inline">
                                                <h4>{this.props.match.params.offer_id ? "Edit" : "Add"}{" "} Offer</h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="page-header-breadcrumb">
                                            <ul className="breadcrumb-title">
                                                ...
                                                <li className="breadcrumb-item active">
                                                    {this.props.match.params.offer_id ? "Edit" : "Add"}{" "} Offer
                                                    </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div className="card-block">
                                                ...
                                                <div className="tab-content tabs">
                                                    <div className="tab-pane  active"
                                                        ...
                                                        {
                                                            this.state.offer_id !== undefined &&
                                                                this.state.offer_id !== null &&
                                                                this.state.offer_id !== 0 &&
                                                                this.state.offer_id !== ''
                                                                ?
                                                                <OfferAdd language_id={this.state.language_id}
