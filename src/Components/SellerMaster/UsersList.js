    ...
    const columns = [
...

      {
        ...
        options: {
          filter: true,
          sort: true,
          customBodyRender: (is_verified, tableMeta) => {
            console.log(tableMeta)
            return (
              <div>
                {" "}
                <Toggle
                  ...
                  checked={is_verified === 'true' ? true : false}
                  value={is_verified}
          ...
          customBodyRender: (status, tableMeta) => {
            ...
            return (
              <div>
                {" "}
                <Switch
                  id={"icon-switch_" + tableMeta.rowData[0]}
                  onChange={this.handleStatusChange1.bind(this, tableMeta.rowData[0])}
          ...
          customBodyRender: uid => {
            return (
              <div>
                ...
                <Link
                  to={"/seller/edit/" + hashids.encode(uid)}
                  className="m-r-15 text-muted"
                  data-toggle="tooltip"
                  data-placement="users" title=""
                ...
                <span
                  onClick={this.removeUser.bind(this, uid)}
                  className="m-r-15 text-muted"
                  data-toggle="tooltip"
                  data-placement="users"
                  title=""
                    ...
                    <MUIDataTable
                      title={
                        <div className="card-header">
                          <h5>Seller List</h5>
                          <Link to="/seller/add"
                            className="btn btn-sm btn-primary waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13"> <i className="icofont icofont-plus m-r-5"></i> Add Seller
                       </Link>
                        </div>
                      }
