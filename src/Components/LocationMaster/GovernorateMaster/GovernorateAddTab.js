...
import GovernorateAdd from "./GovernorateAdd";
...
class GovernorateAddTab extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.governorate_id !== undefined &&
      ...
      var decode_id = hashids.decode(this.props.match.params.governorate_id)
      this.setState({ governorate_id: decode_id[0] })
                  ...
                  <div className="col-lg-8">
                    <div className="page-header-title">
                      <div className="d-inline">
                        <h4>{this.props.match.params.governorate_id ? "Edit" : "Add"}{" "}
                          Governorate</h4>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="page-header-breadcrumb">
                      <ul className="breadcrumb-title">
                        ...
                        <li className="breadcrumb-item active">
                          {this.props.match.params.governorate_id ? "Edit" : "Add"}{" "}
                          Governorate
                    </li>
                      </ul>
                    </div>
                          ...
                          <div className="tab-pane  active"
                            id={"about_" + this.state.language_id} role="tabpanel" aria-labelledby="">
                            {
                              this.state.governorate_id !== undefined &&
                                ...
                                ?
                                <GovernorateAdd language_id={this.state.language_id}
