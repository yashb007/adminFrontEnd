...
class AreaAddTab extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.area_id !== undefined &&
      this.props.match.params.area_id !== null &&
      this.props.match.params.area_id !== 0 &&
      this.props.match.params.area_id !== '') {
      var decode_id = hashids.decode(this.props.match.params.area_id)
      this.setState({ area_id: decode_id[0] })
                  ...
                  <div className="col-lg-8">
                    <div className="page-header-title">
                      <div className="d-inline">
                        <h4>{this.props.match.params.area_id ? "Edit" : "Add"}{" "}
                        Area</h4>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="page-header-breadcrumb">
                      <ul className="breadcrumb-title">
                        ...
                        <li className="breadcrumb-item active">
                          {this.props.match.params.area_id ? "Edit" : "Add"}{" "}
                         Area
                    </li>
                      </ul>
                    </div>
                          ...
                          <div className="tab-pane  active"
                            id={"about_" + this.state.language_id} role="tabpanel" aria-labelledby="">
                            {
                              this.state.area_id !== undefined &&
                                ...
                                this.state.area_id !== ''
                                ?
                                <AreaAdd language_id={this.state.language_id}
