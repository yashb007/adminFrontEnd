...
class TopUpAddTab extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.country_id !== undefined &&
      ...
      var decode_id = hashids.decode(this.props.match.params.country_id)
      this.setState({ country_id: decode_id[0] })
                  ...
                  <div className="col-lg-8">
                    <div className="page-header-title">
                      <div className="d-inline">
                        <h4>{this.props.match.params.country_id ? "Edit" : "Add"}{" "}
                          Country</h4>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="tab-pane  active"
                            id={"about_" + this.state.language_id} role="tabpanel" aria-labelledby="">
                            {
                              this.state.country_id !== undefined &&
                                ...
                                ?
                                <CountryAdd language_id={this.state.language_id}
