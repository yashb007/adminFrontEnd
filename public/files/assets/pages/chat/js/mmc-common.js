...
$(document).on('click', '#main-chat #paper-btn', function (e) {
        ...
        _box_message.append('<div class="message out no-avatar media">' +
            '<div class="body media-body text-right p-l-50"><div class="content msg-reply f-12 bg-primary d-inline-block">'+ text +'</div><div class="seen"><i class="icofont icofont-ui-clock f-12 m-r-5 txt-muted d-inline-block"></i><span><p class="d-inline-block">a few seconds ago </p></span><div class="clear"></div> </div></div>' +
